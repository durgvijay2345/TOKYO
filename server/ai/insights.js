// ============================================================
// TOKYO PULSE — AI/ML Pattern Detection & Insights Engine
// Generates actionable engineering insights from analyzed data
// ============================================================
 ...
 *   - category: what area it affects
 *   - title: short summary
 *   - description: detailed explanation with data
 *   - evidence: supporting metrics
 *
 * Detection Patterns:
 * 1. WORKLOAD IMBALANCE — Top contributor > 50% of commits
 * 2. BUS FACTOR RISK — Bus factor ≤ 1 with multiple contributors
 * 3. HIGH-IMPACT CONTRIBUTORS — Avg impact score > 10
 * 4. CODE CHURN — Files with high add+delete ratio
 * 5. LOW-IMPACT REPETITION — Many commits with low avg impact
 * 6. INACTIVE CONTRIBUTORS — Contributors with < 2% of commits
 * 7. HEALTH ASSESSMENT — Based on overall health score composite
 */
