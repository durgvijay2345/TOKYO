// ============================================================
// TOKYO PULSE — Database Persistence Layer
// MongoDB + Mongoose — replaces the old JSON-file store
// ============================================================
...
// ── CRUD Operations (same interface as old JSON layer) ─────────

/**
 * Save an analysis result to MongoDB.
 * Uses upsert: if a document with the same repoUrl exists, replace it.
 */
...
/**
 * Get all saved analyses (summary only, without the full result).
...
/**
 * Get a full analysis result by its MongoDB _id.
 */
...
/**
 * Get a full analysis result by repo URL.
 * Returns null if the stored entry is older than 10 minutes.
 */
